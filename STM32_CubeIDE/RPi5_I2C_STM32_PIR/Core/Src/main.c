...
/* USER CODE BEGIN PV */
uint8_t tx_buffer[3];      // [motion(0/1), lux_hi, lux_lo]
uint8_t bh1750_raw[2];     // raw two bytes from BH1750
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
/* Optional: BH1750 address (7-bit) */
#define BH1750_ADDR (0x23 << 1) // left-shifted for HAL functions (address in HAL functions is 8-bit)
#define STM32_SLAVE_ADDR (0x27 << 1) // cubeMX often stores shifted; ensure consistency
